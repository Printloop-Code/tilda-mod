...
const logIssue = (key, payload) => {
    try {
        if (typeof window.OpenReplay?.issue === 'function') {
            window.OpenReplay.issue(key, payload);
        }
    }
    catch (e) {
