...
/*!**************************!*\
  !*** ./src/utils/api.ts ***!
  \**************************/(t,e,o)=>{o.r(e),o.d(e,{createProduct:()=>function({quantity:t,name:e,size:o,color:i,sides:s,article:r,price:a}){var n="698341642832_"+Date.now(),l=1<s.length?`<a target="_blank" href="${s[0]?.image_url}" target="_blank">${s[0]?.image_url.slice(-10)}</a>, <a target="_blank" href="${s[1]?.image_url}" target="_blank">${s[1]?.image_url.slice(-10)}</a>`:`<a target="_blank" href="${s[0]?.image_url}" target="_blank">${s[0]?.image_url.slice(-10)}</a>`,n={id:n,name:e,price:a,quantity:t,img:s[0]?.image_url,options:[{option:"Размер",variant:o},{option:"Дизайн",variant:l},{option:"Артикул",variant:r},{option:"Цвет",variant:i.name},{option:"Принт",variant:1==s.length?"Односторонний":"Двухсторонний"}]};if(console.debug("[cart] add product",n),"function"==typeof window.tcart__addProduct)try{window.tcart__addProduct(n)}catch(t){console.error("[cart] Ошибка при добавлении продукта в корзину",t)}else console.warn("[cart] Корзина Tilda не загружена.")},generateImage:()=>async function({prompt:t,shirtColor:e,image:o,withAi:i,layoutId:s,isNew:r=!0}){var a=new d.EditorStorageManager,a=await a.getUserId(),n=new FormData;n.set("userId",a),n.set("prompt",t),n.set("shirtColor",e),n.set("placement","center"),n.set("printSize","big"),n.set("transferType",""),n.set("request_type","generate"),s&&n.set("layoutId",s);if(o){console.debug("[generate image]",o);var[a,t]=o.split(","),e=a.split(":")[1].split(";")[0],l=(console.debug("[generate image] [type]",e),atob(t)),c=new Array(l.length);for(let t=0;t<l.length;t++)c[t]=l.charCodeAt(t);s=new Uint8Array(c);n.set("request_type","image"),n.set("user_image",new Blob([s],{type:"image/png"})),n.set("transferType",i?"ai":"no-ai")}r||n.set("request_type","edit");o=await fetch(u.WEBHOOK_REQUEST,{method:"POST",body:n}),a=await o.json();return a.image_url||a.image}});var d=o(/*! ../managers/EditorStorageManager */"./src/managers/EditorStorageManager.ts");let u={WEBHOOK_REQUEST:"https://primary-production-654c.up.railway.app/webhook/request"}},"./src/utils/tildaUtils.ts":
/*!*********************************!*\
