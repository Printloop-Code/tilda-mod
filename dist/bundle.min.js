...
/*!**************************!*\
  !*** ./src/utils/api.ts ***!
  \**************************/(t,e,o)=>{o.r(e),o.d(e,{createProduct:()=>function({quantity:t,name:e,size:o,color:i,sides:s,productType:r,article:a}){var n=(Math.random()+1).toString(36).substring(7)+"_"+Date.now(),l=d.productConfigs.find(t=>t.type===r),l=1==s.length?l?.price||1990:l?.doubleSidedPrice||2490,n={id:n,name:e,price:l,quantity:t,img:s[0]?.image_url,options:[{option:"Дизайн",variant:`<a target="_blank" href="${s[0]?.image_url}" target="_blank">${s[0]?.image_url.slice(-10)}</a>`},1<s.length&&{option:"Дизайн",variant:`<a target="_blank" href="${s[1]?.image_url}" target="_blank">${s[1]?.image_url.slice(-10)}</a>`},{option:"Артикул",variant:a},{option:"Размер",variant:o},{option:"Цвет",variant:i.name},{option:"Принт",variant:1==s.length?"Односторонний":"Двухсторонний"}]};if(console.debug("[cart] add product",n),"function"==typeof window.tcart__addProduct)try{window.tcart__addProduct(n)}catch(t){console.error("[cart] Ошибка при добавлении продукта в корзину",t)}else console.warn("[cart] Корзина Tilda не загружена.")},generateImage:()=>async function({prompt:t,shirtColor:e,image:o,withAi:i,layoutId:s,isNew:r=!0}){var a=new c.EditorStorageManager,a=await a.getUserId(),n=new FormData;n.set("userId",a),n.set("prompt",t),n.set("shirtColor",e),n.set("placement","center"),n.set("printSize","big"),n.set("transferType",""),n.set("request_type","generate"),s&&n.set("layoutId",s);if(o){console.debug("[generate image]",o);var[a,t]=o.split(","),e=a.split(":")[1].split(";")[0],l=(console.debug("[generate image] [type]",e),atob(t)),d=new Array(l.length);for(let t=0;t<l.length;t++)d[t]=l.charCodeAt(t);s=new Uint8Array(d);n.set("request_type","image"),n.set("user_image",new Blob([s],{type:"image/png"})),n.set("transferType",i?"ai":"no-ai")}r||n.set("request_type","edit");o=await fetch(u.WEBHOOK_REQUEST,{method:"POST",body:n}),a=await o.json();return a.image_url||a.image}});var c=o(/*! ../managers/EditorStorageManager */"./src/managers/EditorStorageManager.ts"),d=o(/*! ../config/products */"./src/config/products.ts");let u={WEBHOOK_REQUEST:"https://primary-production-654c.up.railway.app/webhook/request"}},"./src/utils/tildaUtils.ts":
/*!*********************************!*\
