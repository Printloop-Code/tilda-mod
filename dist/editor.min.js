...
/*!**************************!*\
  !*** ./src/utils/api.ts ***!
  \**************************/(t,e,i)=>{i.r(e),i.d(e,{createProduct:()=>function({quantity:t,name:e,size:i,color:o,sides:s,article:a,price:r}){var n="698341642832_"+Date.now(),l=1<s.length?`<a target="_blank" href="${s[0]?.image_url}" target="_blank">${s[0]?.image_url.slice(-10)}</a>, <a target="_blank" href="${s[1]?.image_url}" target="_blank">${s[1]?.image_url.slice(-10)}</a>`:`<a target="_blank" href="${s[0]?.image_url}" target="_blank">${s[0]?.image_url.slice(-10)}</a>`,n={id:n,name:e,price:r,quantity:t,img:s[0]?.image_url,options:[{option:"Размер",variant:i},{option:"Дизайн",variant:l},{option:"Артикул",variant:a},{option:"Цвет",variant:o.name},{option:"Принт",variant:1==s.length?"Односторонний":"Двухсторонний"}]};if(console.debug("[cart] add product",n),"function"==typeof window.tcart__addProduct)try{window.tcart__addProduct(n);try{window.ym(103279214,"reachGoal","add_to_cart")}catch(t){}}catch(t){console.error("[cart] Ошибка при добавлении продукта в корзину",t)}else console.warn("[cart] Корзина Tilda не загружена.")},generateImage:()=>async function({uri:t,prompt:e,shirtColor:i,image:o,withAi:s,layoutId:a,isNew:r=!0,background:n=!0}){var l=new u.EditorStorageManager,l=await l.getUserId(),d=new FormData;d.set("userId",l),d.set("prompt",e),d.set("shirtColor",i),d.set("placement","center"),d.set("printSize","big"),d.set("transferType",""),d.set("request_type","generate"),d.set("background",n.toString()),a&&d.set("layoutId",a);if(o){console.debug("[generate image]",o);var[l,e]=o.split(","),i=l.split(":")[1].split(";")[0],c=(console.debug("[generate image] [type]",i),atob(e)),h=new Array(c.length);for(let t=0;t<c.length;t++)h[t]=c.charCodeAt(t);n=new Uint8Array(h);d.set("request_type","image"),d.set("user_image",new Blob([n],{type:"image/png"})),d.set("transferType",s?"ai":"no-ai")}r||d.set("request_type","edit");a=await fetch(t,{method:"POST",body:d}),o=await a.json();return o.image_url||o.image}});var u=i(/*! ../managers/EditorStorageManager */"./src/managers/EditorStorageManager.ts")},"./src/utils/canvasUtils.ts":
/*!**********************************!*\
  !*** ./src/utils/canvasUtils.ts ***!
  \**********************************/(t,e,i)=>{function l(e,t,i,o){var s,a,t=t.printConfig.find(t=>t.side===e.view);if(t)return s=t.size.width/600*i,a=t.size.height/600*o,i=Math.round((i-s)/2+t.position.x/100*i),t=Math.round((o-a)/2+t.position.y/100*o),{left:i+s*e.position.x,top:t+a*e.position.y,scaleX:e.size,scaleY:e.size*e.aspectRatio,angle:e.angle,printAreaWidth:s,printAreaHeight:a,printAreaLeft:i,printAreaTop:t};throw new Error("Print config not found for side: "+e.view)}i.r(e),i.d(e,{calculateLayoutDimensions:()=>l,renderLayout:()=>async function(e){var{layout:e,product:i,containerWidth:o,containerHeight:s,loadImage:a}=e,i=l(e,i,o,s),o=window.fabric;if(o){if(e.isImageLayout()){s=await a(e.url),a=new o.Image(s);let t=e.size;var r,n=e._relativeWidth;return n&&0<n?(r=i.printAreaWidth*n,t=r/s.width,console.debug(`[renderLayout] Адаптация к новому размеру: relativeWidth=${n.toFixed(3)}, targetWidth=${r.toFixed(1)}px, scale=`+t.toFixed(3))):1===e.size&&s.width>i.printAreaWidth?(t=i.printAreaWidth/s.width,e.size=t,r=s.width*t/i.printAreaWidth,e._relativeWidth=r,console.debug(`[renderLayout] Автоподгонка размера: ${s.width}px → ${i.printAreaWidth}px, scale=${t.toFixed(3)}, relativeWidth=`+r.toFixed(3))):n&&0!==n||(n=s.width*e.size/i.printAreaWidth,e._relativeWidth=n,console.debug("[renderLayout] Вычислен _relativeWidth для старого layout: "+n.toFixed(3))),a.set({left:i.left,top:i.top,scaleX:t,scaleY:t*e.aspectRatio,angle:i.angle,name:e.id,layoutUrl:e.url}),a}if(e.isTextLayout())return(s=new o.Text(e.text,{fontFamily:e.font.family,fontSize:e.font.size})).set({left:i.left,top:i.top,scaleX:i.scaleX,scaleY:i.scaleY,angle:i.angle,name:e.id}),s}else console.error("[renderLayout] fabric.js не загружен");return null},renderLayoutToCanvas:()=>async function(t,e,i,o,s,a){i=l(e,i,o,s);e.isImageLayout()?(o=await a(e.url),t.save(),t.translate(i.left,i.top),t.rotate(i.angle*Math.PI/180),s=o.width*i.scaleX,a=o.height*i.scaleY,t.drawImage(o,0,0,s,a),t.restore()):e.isTextLayout()&&(t.save(),t.translate(i.left,i.top),t.rotate(i.angle*Math.PI/180),t.font=e.font.size*i.scaleX+"px "+e.font.family,t.fillStyle="black",t.fillText(e.text,0,0),t.restore())}})},"./src/utils/tildaUtils.ts":
/*!*********************************!*\
...
/*!*******************************!*\
  ...
  \*******************************/
s.r(e),s.d(e,{default:()=>t});var a=s(/*! ../components/Editor */"./src/components/Editor.ts");"undefined"!=typeof window&&(window.Editor=a.default);let t=a.default}return e});